...
namespace EletronicECommerce.UseCase.Implementation.Builder
{
    public class CreateCustomerBuilder : ICreateCustomerBuilder
    {
        ...
        public Customer CallRepository() => _customerRepository.Create(_customer);
        ...
        {
            _customer.Validate();
            RegisterCustomerUseCaseValidation.Validate(_customer, _customerRepository, _userRepository);
